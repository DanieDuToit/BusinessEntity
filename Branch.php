...
<?php
    ...
    if (isset($_POST['Create']) === false) {
        ...
        $divisionStmnt = $dbBaseClass->getFieldsForAll("BusinessEntity",
            array('BusinessEntityParentId'),
            "WHERE id = {$_GET['entityId']}");
        ...
        $companyStmnt = $dbBaseClass->getFieldsForAll("BusinessEntity", array('Name', 'Id', 'BusinessEntityParentId'),
            "WHERE id = $divisionId");
